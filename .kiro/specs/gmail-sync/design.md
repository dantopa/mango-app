...
### Formatos reales de email (evidencia)
...
export interface CandidateTransaction {
  ...
  expense_type?: "fixed" | "variable"; // default "variable"; arriendo usa "fixed"
  card_last4?: string | null;          // *5685 / *3679 / ••5685 — clave fuerte de dedup
}
```
