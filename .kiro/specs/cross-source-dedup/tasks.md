...
- [x] **1.2 Persistir señales en ambos inserts**
...
- [x] **2.1 `src/lib/sync/dedup-core.ts`**
...
- [x] **2.2 Multiplicidad en `resolveDuplicate`**
...
- [x] **2.3 `evaluateCandidate` → wrapper de `resolveDuplicate`**
...
- [x] **3.1 Tests de regresión de los bugs reales (PRIMERO)**
...
- [x] **3.2 Reordenar pipeline: FX antes de dedup**
...
- [x] **3.3 Reemplazar `findCrossSourceDuplicate` por `resolveDuplicate`**
...
- [x] **4.2 Validación con datos reales**
...
- [x] **4.3 Limpieza de los duplicados ya existentes (one-off)**
