...
- [ ] **0.1 Google Cloud setup (manual, fuera del repo)**
...
- [ ] **0.2 Migración `20260101000009_gmail_vault_rpc.sql`**
...
- [ ] **1.1 `src/lib/sync/gmail/types.ts`**
...
- [ ] **1.2 `src/lib/sync/gmail/token-store.ts`**
...
- [ ] **1.3 `src/lib/sync/gmail/client.ts`**
...
- [ ] **1.4 `src/lib/sync/gmail/html-to-text.ts`**
...
- [ ] **2.1 `src/lib/sync/gmail/money.ts`**
...
- [ ] **2.2 Parser Bancolombia (`sources/bancolombia.ts`)**
...
- [ ] **2.3 Parser RappiCard (`sources/rappicard.ts`)**
...
- [ ] **2.4 Parser Arriendo (`sources/arriendo.ts`)**
...
- [ ] **3.1 `expense_type` opcional en el engine**
...
- [ ] **3.2 Idempotencia (`orchestrator.ts`, parte 1)**
...
- [ ] **3.3 Orquestador (`orchestrator.ts`, parte 2)**
...
- [ ] **3.5 Test de idempotencia end-to-end**
...
- [ ] **4.2 `use-sync.ts`: fuente gmail con loop de cursor**
...
- [ ] **4.3 `sync-dialog.tsx`: checkbox Gmail + sub-resultados + CTA**
...
- [ ] **6.2 E2E manual (checklist del design §11)**
